 ...
 *         &lt;element name="CarrierCode" type="{http://fedex.com/ws/ship/v26}CarrierCodeType" minOccurs="0"/&gt;
 *         &lt;element name="MasterTrackingId" type="{http://fedex.com/ws/ship/v26}TrackingId" minOccurs="0"/&gt;
 *         &lt;element name="ServiceDescription" type="{http://fedex.com/ws/ship/v26}ServiceDescription" minOccurs="0"/&gt;
 *         &lt;element name="PackagingDescription" type="{http://fedex.com/ws/ship/v26}PackagingDescription" minOccurs="0"/&gt;
 ...
 *         &lt;element name="OperationalDetail" type="{http://fedex.com/ws/ship/v26}ShipmentOperationalDetail" minOccurs="0"/&gt;
 *         &lt;element name="AccessDetail" type="{http://fedex.com/ws/ship/v26}PendingShipmentAccessDetail" minOccurs="0"/&gt;
 *         &lt;element name="TagDetail" type="{http://fedex.com/ws/ship/v26}CompletedTagDetail" minOccurs="0"/&gt;
 *         &lt;element name="SmartPostDetail" type="{http://fedex.com/ws/ship/v26}CompletedSmartPostDetail" minOccurs="0"/&gt;
 *         &lt;element name="HazardousShipmentDetail" type="{http://fedex.com/ws/ship/v26}CompletedHazardousShipmentDetail" minOccurs="0"/&gt;
 *         &lt;element name="ShipmentRating" type="{http://fedex.com/ws/ship/v26}ShipmentRating" minOccurs="0"/&gt;
 *         &lt;element name="CompletedHoldAtLocationDetail" type="{http://fedex.com/ws/ship/v26}CompletedHoldAtLocationDetail" minOccurs="0"/&gt;
 *         &lt;element name="ExportComplianceStatement" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/&gt;
 *         &lt;element name="DocumentRequirements" type="{http://fedex.com/ws/ship/v26}DocumentRequirementsDetail" minOccurs="0"/&gt;
 *         &lt;element name="CompletedEtdDetail" type="{http://fedex.com/ws/ship/v26}CompletedEtdDetail" minOccurs="0"/&gt;
 *         &lt;element name="ShipmentDocuments" type="{http://fedex.com/ws/ship/v26}ShippingDocument" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="AssociatedShipments" type="{http://fedex.com/ws/ship/v26}AssociatedShipmentDetail" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="CompletedCodDetail" type="{http://fedex.com/ws/ship/v26}CompletedCodDetail" minOccurs="0"/&gt;
 *         &lt;element name="CompletedPackageDetails" type="{http://fedex.com/ws/ship/v26}CompletedPackageDetail" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
