 ...
 *       &lt;sequence&gt;
 *         &lt;element name="Brokers" type="{http://fedex.com/ws/ship/v26}BrokerDetail" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="ClearanceBrokerage" type="{http://fedex.com/ws/ship/v26}ClearanceBrokerageType" minOccurs="0"/&gt;
 *         &lt;element name="CustomsOptions" type="{http://fedex.com/ws/ship/v26}CustomsOptionDetail" minOccurs="0"/&gt;
 *         &lt;element name="ImporterOfRecord" type="{http://fedex.com/ws/ship/v26}Party" minOccurs="0"/&gt;
 *         &lt;element name="RecipientCustomsId" type="{http://fedex.com/ws/ship/v26}RecipientCustomsId" minOccurs="0"/&gt;
 *         &lt;element name="DutiesPayment" type="{http://fedex.com/ws/ship/v26}Payment" minOccurs="0"/&gt;
 *         &lt;element name="DocumentContent" type="{http://fedex.com/ws/ship/v26}InternationalDocumentContentType" minOccurs="0"/&gt;
 *         &lt;element name="CustomsValue" type="{http://fedex.com/ws/ship/v26}Money" minOccurs="0"/&gt;
 *         &lt;element name="FreightOnValue" type="{http://fedex.com/ws/ship/v26}FreightOnValueType" minOccurs="0"/&gt;
 *         &lt;element name="InsuranceCharges" type="{http://fedex.com/ws/ship/v26}Money" minOccurs="0"/&gt;
 *         &lt;element name="PartiesToTransactionAreRelated" type="{http://www.w3.org/2001/XMLSchema}boolean" minOccurs="0"/&gt;
 *         &lt;element name="CommercialInvoice" type="{http://fedex.com/ws/ship/v26}CommercialInvoice" minOccurs="0"/&gt;
 *         &lt;element name="Commodities" type="{http://fedex.com/ws/ship/v26}Commodity" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="ExportDetail" type="{http://fedex.com/ws/ship/v26}ExportDetail" minOccurs="0"/&gt;
 *         &lt;element name="RegulatoryControls" type="{http://fedex.com/ws/ship/v26}RegulatoryControlType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="DeclarationStatementDetail" type="{http://fedex.com/ws/ship/v26}CustomsDeclarationStatementDetail" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
