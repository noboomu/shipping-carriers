...
/**
 * <p>Java class for ReprintShippingDocumentsReply complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="ReprintShippingDocumentsReply"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element name="PackageDocuments" type="{http://fedex.com/ws/openship/v18}PackageDocument" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "ReprintShippingDocumentsReply", propOrder = {
    "highestSeverity",
    "notifications",
    "transactionDetail",
    "version",
...
public class ReprintShippingDocumentsReply {
    ...
    protected List<PackageDocument> packageDocuments;
    ...
    public List<PackageDocument> getPackageDocuments() {
        if (packageDocuments == null) {
            packageDocuments = new ArrayList<PackageDocument>();
        }
