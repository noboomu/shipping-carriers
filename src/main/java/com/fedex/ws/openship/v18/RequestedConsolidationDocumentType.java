...
/**
 * <p>Java class for RequestedConsolidationDocumentType.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <pre>
 * &lt;simpleType name="RequestedConsolidationDocumentType"&gt;
 ...
 *     &lt;enumeration value="CONSOLIDATED_PARTY_REPORT"/&gt;
 ...
 * 
 */
@XmlType(name = "RequestedConsolidationDocumentType")
@XmlEnum
public enum RequestedConsolidationDocumentType {
    ...
    public static RequestedConsolidationDocumentType fromValue(String v) {
        return valueOf(v);
    }
