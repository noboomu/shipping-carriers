 ...
 *         &lt;element name="CustomContentPosition" type="{http://fedex.com/ws/uploaddocument/v17}RelativeVerticalPositionType" minOccurs="0"/&gt;
 *         &lt;element name="CustomContent" type="{http://fedex.com/ws/uploaddocument/v17}CustomLabelDetail" minOccurs="0"/&gt;
 *         &lt;element name="ConfigurableReferenceEntries" type="{http://fedex.com/ws/uploaddocument/v17}ConfigurableLabelReferenceEntry" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="MaskedData" type="{http://fedex.com/ws/uploaddocument/v17}LabelMaskableDataType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="SecondaryBarcode" type="{http://fedex.com/ws/uploaddocument/v17}SecondaryBarcodeType" minOccurs="0"/&gt;
 *         &lt;element name="TermsAndConditionsLocalization" type="{http://fedex.com/ws/uploaddocument/v17}Localization" minOccurs="0"/&gt;
 *         &lt;element name="RegulatoryLabels" type="{http://fedex.com/ws/uploaddocument/v17}RegulatoryLabelContentDetail" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="AdditionalLabels" type="{http://fedex.com/ws/uploaddocument/v17}AdditionalLabelsDetail" maxOccurs="unbounded" minOccurs="0"/&gt;
