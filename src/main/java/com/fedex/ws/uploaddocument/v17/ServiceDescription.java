 ...
 *         &lt;element name="Names" type="{http://fedex.com/ws/uploaddocument/v17}ProductName" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="OperatingOrgCodes" type="{http://www.w3.org/2001/XMLSchema}string" maxOccurs="unbounded" minOccurs="0"/&gt;
...
public class ServiceDescription {
    ...
    @XmlElement(name = "OperatingOrgCodes")
    protected List<String> operatingOrgCodes;
    ...
    /**
     * Gets the value of the operatingOrgCodes property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the Jakarta XML Binding object.
     * This is why there is not a <CODE>set</CODE> method for the operatingOrgCodes property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getOperatingOrgCodes().add(newItem);
     * </pre>
     * 
     * 
     * <p>
    ...
    public List<String> getOperatingOrgCodes() {
        if (operatingOrgCodes == null) {
            operatingOrgCodes = new ArrayList<String>();
        }
