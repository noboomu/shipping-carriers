 ...
 *         &lt;element name="DropoffType" type="{http://fedex.com/ws/uploaddocument/v17}DropoffType" minOccurs="0"/&gt;
 ...
 *         &lt;element name="ManifestDetail" type="{http://fedex.com/ws/uploaddocument/v17}ShipmentManifestDetail" minOccurs="0"/&gt;
 *         &lt;element name="VariationOptions" type="{http://fedex.com/ws/uploaddocument/v17}ShipmentVariationOptionDetail" maxOccurs="unbounded" minOccurs="0"/&gt;
 ...
 *         &lt;element name="TotalDimensions" type="{http://fedex.com/ws/uploaddocument/v17}Dimensions" minOccurs="0"/&gt;
 *         &lt;element name="PreferredCurrency" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/&gt;
 *         &lt;element name="ShipmentAuthorizationDetail" type="{http://fedex.com/ws/uploaddocument/v17}ShipmentAuthorizationDetail" minOccurs="0"/&gt;
 *         &lt;element name="Shipper" type="{http://fedex.com/ws/uploaddocument/v17}Party" minOccurs="0"/&gt;
 *         &lt;element name="Recipient" type="{http://fedex.com/ws/uploaddocument/v17}Party" minOccurs="0"/&gt;
 *         &lt;element name="RecipientLocationNumber" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/&gt;
 *         &lt;element name="Origin" type="{http://fedex.com/ws/uploaddocument/v17}ContactAndAddress" minOccurs="0"/&gt;
 *         &lt;element name="SoldTo" type="{http://fedex.com/ws/uploaddocument/v17}Party" minOccurs="0"/&gt;
 *         &lt;element name="ShippingChargesPayment" type="{http://fedex.com/ws/uploaddocument/v17}Payment" minOccurs="0"/&gt;
 *         &lt;element name="SpecialServicesRequested" type="{http://fedex.com/ws/uploaddocument/v17}ShipmentSpecialServicesRequested" minOccurs="0"/&gt;
 *         &lt;element name="ProcessingOptionsRequested" type="{http://fedex.com/ws/uploaddocument/v17}ShipmentProcessingOptionsRequested" minOccurs="0"/&gt;
 *         &lt;element name="ExpressFreightDetail" type="{http://fedex.com/ws/uploaddocument/v17}ExpressFreightDetail" minOccurs="0"/&gt;
 *         &lt;element name="FreightShipmentDetail" type="{http://fedex.com/ws/uploaddocument/v17}FreightShipmentDetail" minOccurs="0"/&gt;
 *         &lt;element name="ConsolidationDetail" type="{http://fedex.com/ws/uploaddocument/v17}ShipmentConsolidationDetail" minOccurs="0"/&gt;
 ...
 *         &lt;element name="CustomsClearanceDetail" type="{http://fedex.com/ws/uploaddocument/v17}CustomsClearanceDetail" minOccurs="0"/&gt;
 *         &lt;element name="PickupDetail" type="{http://fedex.com/ws/uploaddocument/v17}PickupDetail" minOccurs="0"/&gt;
 *         &lt;element name="SmartPostDetail" type="{http://fedex.com/ws/uploaddocument/v17}SmartPostShipmentDetail" minOccurs="0"/&gt;
 *         &lt;element name="BlockInsightVisibility" type="{http://www.w3.org/2001/XMLSchema}boolean" minOccurs="0"/&gt;
 *         &lt;element name="ErrorLabelBehavior" type="{http://fedex.com/ws/uploaddocument/v17}ErrorLabelBehaviorType" minOccurs="0"/&gt;
 *         &lt;element name="LabelSpecification" type="{http://fedex.com/ws/uploaddocument/v17}LabelSpecification" minOccurs="0"/&gt;
 *         &lt;element name="ShippingDocumentSpecification" type="{http://fedex.com/ws/uploaddocument/v17}ShippingDocumentSpecification" minOccurs="0"/&gt;
 *         &lt;element name="RateRequestTypes" type="{http://fedex.com/ws/uploaddocument/v17}RateRequestType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="CustomerSelectedActualRateType" type="{http://fedex.com/ws/uploaddocument/v17}ReturnedRateType" minOccurs="0"/&gt;
 *         &lt;element name="EdtRequestType" type="{http://fedex.com/ws/uploaddocument/v17}EdtRequestType" minOccurs="0"/&gt;
 *         &lt;element name="CustomRatingOptionDetail" type="{http://fedex.com/ws/uploaddocument/v17}CustomRatingOptionDetail" minOccurs="0"/&gt;
 *         &lt;element name="MasterTrackingId" type="{http://fedex.com/ws/uploaddocument/v17}TrackingId" minOccurs="0"/&gt;
 *         &lt;element name="PackageCount" type="{http://www.w3.org/2001/XMLSchema}nonNegativeInteger" minOccurs="0"/&gt;
 *         &lt;element name="ShipmentOnlyFields" type="{http://fedex.com/ws/uploaddocument/v17}ShipmentOnlyFieldsType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="ConfigurationData" type="{http://fedex.com/ws/uploaddocument/v17}ShipmentConfigurationData" minOccurs="0"/&gt;
 *         &lt;element name="RequestedPackageLineItems" type="{http://fedex.com/ws/uploaddocument/v17}RequestedPackageLineItem" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
