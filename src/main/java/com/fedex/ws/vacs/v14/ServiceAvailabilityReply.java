...
/**
 * <p>Java class for ServiceAvailabilityReply complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="ServiceAvailabilityReply"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element name="Options" type="{http://fedex.com/ws/vacs/v14}ServiceAvailabilityOption" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "ServiceAvailabilityReply", propOrder = {
    "highestSeverity",
    "notifications",
    "transactionDetail",
    "version",
...
public class ServiceAvailabilityReply {
    ...
    protected List<ServiceAvailabilityOption> options;
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link ServiceAvailabilityOption }
     * 
     * 
     */
    public List<ServiceAvailabilityOption> getOptions() {
        if (options == null) {
            options = new ArrayList<ServiceAvailabilityOption>();
        }
        return this.options;
    }
