 ...
 *         &lt;element name="Type" type="{http://fedex.com/ws/vacs/v14}ConsolidationType" minOccurs="0"/&gt;
 *         &lt;element name="Role" type="{http://fedex.com/ws/vacs/v14}ConsolidationShipmentRoleType" minOccurs="0"/&gt;
 *         &lt;element name="AssociatedTrackingIds" type="{http://fedex.com/ws/vacs/v14}AssociatedTrackingId" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="SpecialServicesRequested" type="{http://fedex.com/ws/vacs/v14}ConsolidationSpecialServicesRequested" minOccurs="0"/&gt;
 *         &lt;element name="ConsolidationOriginAddress" type="{http://fedex.com/ws/vacs/v14}Address" minOccurs="0"/&gt;
 *         &lt;element name="InternationalDistributionDetail" type="{http://fedex.com/ws/vacs/v14}ShipmentInternationalDistributionDetail" minOccurs="0"/&gt;
 *         &lt;element name="TransborderDistributionDetail" type="{http://fedex.com/ws/vacs/v14}ShipmentTransborderDistributionDetail" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class ShipmentConsolidationDetail {
    ...
    @XmlElement(name = "ConsolidationOriginAddress")
    protected Address consolidationOriginAddress;
    ...
    /**
     * Gets the value of the consolidationOriginAddress property.
     * 
     * @return
     *     possible object is
     *     {@link Address }
     *     
     */
    public Address getConsolidationOriginAddress() {
        return consolidationOriginAddress;
    }

    /**
     * Sets the value of the consolidationOriginAddress property.
     * 
     * @param value
     *     allowed object is
     *     {@link Address }
     *     
     */
    public void setConsolidationOriginAddress(Address value) {
        this.consolidationOriginAddress = value;
    }
