 ...
 *       &lt;sequence&gt;
 *         &lt;element name="Brokers" type="{http://fedex.com/ws/vacs/v14}BrokerDetail" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="ClearanceBrokerage" type="{http://fedex.com/ws/vacs/v14}ClearanceBrokerageType" minOccurs="0"/&gt;
 *         &lt;element name="CustomsOptions" type="{http://fedex.com/ws/vacs/v14}CustomsOptionDetail" minOccurs="0"/&gt;
 *         &lt;element name="ImporterOfRecord" type="{http://fedex.com/ws/vacs/v14}Party" minOccurs="0"/&gt;
 *         &lt;element name="RecipientCustomsId" type="{http://fedex.com/ws/vacs/v14}RecipientCustomsId" minOccurs="0"/&gt;
 *         &lt;element name="DutiesPayment" type="{http://fedex.com/ws/vacs/v14}Payment" minOccurs="0"/&gt;
 *         &lt;element name="DocumentContent" type="{http://fedex.com/ws/vacs/v14}InternationalDocumentContentType" minOccurs="0"/&gt;
 *         &lt;element name="CustomsValue" type="{http://fedex.com/ws/vacs/v14}Money" minOccurs="0"/&gt;
 *         &lt;element name="FreightOnValue" type="{http://fedex.com/ws/vacs/v14}FreightOnValueType" minOccurs="0"/&gt;
 *         &lt;element name="InsuranceCharges" type="{http://fedex.com/ws/vacs/v14}Money" minOccurs="0"/&gt;
 *         &lt;element name="PartiesToTransactionAreRelated" type="{http://www.w3.org/2001/XMLSchema}boolean" minOccurs="0"/&gt;
 *         &lt;element name="CommercialInvoice" type="{http://fedex.com/ws/vacs/v14}CommercialInvoice" minOccurs="0"/&gt;
 *         &lt;element name="Commodities" type="{http://fedex.com/ws/vacs/v14}Commodity" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="ExportDetail" type="{http://fedex.com/ws/vacs/v14}ExportDetail" minOccurs="0"/&gt;
 *         &lt;element name="RegulatoryControls" type="{http://fedex.com/ws/vacs/v14}RegulatoryControlType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="DeclarationStatementDetail" type="{http://fedex.com/ws/vacs/v14}CustomsDeclarationStatementDetail" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
