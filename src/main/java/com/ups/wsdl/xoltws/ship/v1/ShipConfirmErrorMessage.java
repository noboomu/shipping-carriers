...
public class ShipConfirmErrorMessage
    extends Exception
{
     ...
     * @param message
     */
    public ShipConfirmErrorMessage(String message, Errors faultInfo) {
        super(message);
     ...
     * @param message
     */
    public ShipConfirmErrorMessage(String message, Errors faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
