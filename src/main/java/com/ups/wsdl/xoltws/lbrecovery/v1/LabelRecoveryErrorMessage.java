...
public class LabelRecoveryErrorMessage
    extends Exception
{
     ...
     * @param message
     */
    public LabelRecoveryErrorMessage(String message, Errors faultInfo) {
        super(message);
     ...
     * @param message
     */
    public LabelRecoveryErrorMessage(String message, Errors faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
