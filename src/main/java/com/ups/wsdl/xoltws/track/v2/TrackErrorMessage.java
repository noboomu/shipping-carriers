...
public class TrackErrorMessage
    extends Exception
{
     ...
     * @param message
     */
    public TrackErrorMessage(String message, Errors faultInfo) {
        super(message);
     ...
     * @param message
     */
    public TrackErrorMessage(String message, Errors faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
