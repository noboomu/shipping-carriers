    ...
    extends Exception
{
     ...
     * @param message
     */
    public VoidErrorMessage(String message, Errors faultInfo) {
        super(message);
     ...
     * @param message
     */
    public VoidErrorMessage(String message, Errors faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
