...
public class TimeInTransitErrorMessage
    extends Exception
{
     ...
     * @param message
     */
    public TimeInTransitErrorMessage(String message, Errors faultInfo) {
        super(message);
     ...
     * @param message
     */
    public TimeInTransitErrorMessage(String message, Errors faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
