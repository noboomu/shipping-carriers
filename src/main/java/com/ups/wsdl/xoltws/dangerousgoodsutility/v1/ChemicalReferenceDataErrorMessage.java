...
public class ChemicalReferenceDataErrorMessage
    extends Exception
{
     ...
     * @param message
     */
    public ChemicalReferenceDataErrorMessage(String message, Errors faultInfo) {
        super(message);
     ...
     * @param message
     */
    public ChemicalReferenceDataErrorMessage(String message, Errors faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
