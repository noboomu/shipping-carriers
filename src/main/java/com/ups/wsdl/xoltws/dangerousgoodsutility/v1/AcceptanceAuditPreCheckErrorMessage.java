...
public class AcceptanceAuditPreCheckErrorMessage
    extends Exception
{
     ...
     * @param message
     */
    public AcceptanceAuditPreCheckErrorMessage(String message, Errors faultInfo) {
        super(message);
     ...
     * @param message
     */
    public AcceptanceAuditPreCheckErrorMessage(String message, Errors faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
