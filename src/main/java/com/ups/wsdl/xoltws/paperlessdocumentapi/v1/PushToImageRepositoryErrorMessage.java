...
public class PushToImageRepositoryErrorMessage
    extends Exception
{
     ...
     * @param message
     */
    public PushToImageRepositoryErrorMessage(String message, Errors faultInfo) {
        super(message);
     ...
     * @param message
     */
    public PushToImageRepositoryErrorMessage(String message, Errors faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
