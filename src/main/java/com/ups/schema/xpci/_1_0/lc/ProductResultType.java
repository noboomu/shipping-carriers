...
/**
 * <p>Java class for ProductResultType complex type.
 * 
 ...
 *         &lt;element name="Question" type="{http://www.ups.com/schema/xpci/1.0/lc}QuestionType" maxOccurs="3" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "ProductResultType", propOrder = {
    "tariffCode",
    "question"
})
