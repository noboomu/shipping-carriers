 ...
 *         &lt;element name="SimpleRate" type="{http://www.ups.com/XMLSchema/XOLTWS/Ship/v1.0}SimpleRateType" minOccurs="0"/&gt;
...
public class PackageResultsType {
    ...
    protected SimpleRateType simpleRate;
     ...
     *     
     */
    public SimpleRateType getSimpleRate() {
        return simpleRate;
    }
     ...
     *     
     */
    public void setSimpleRate(SimpleRateType value) {
